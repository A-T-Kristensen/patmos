...
HD_PWD='/home/patmos/t-crest/patmos/hardware/vivado/minver_float_1b_32x32_buffer/minver_float.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log patmos_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source patmos_top.tcl
