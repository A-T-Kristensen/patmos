...
HD_PWD='/home/patmos/t-crest/patmos/hardware/vivado/minver_float_1b_32x32_buffer/minver_float.runs/ddr2_ctrl_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr2_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr2_ctrl.tcl
