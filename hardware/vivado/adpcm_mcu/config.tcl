...
open_project ./hardware/vivado/adpcm_mcu/adpcm.xpr
open_hw
connect_hw_server
# Maybe the following line is not corret for all PCs
open_hw_target
set_property PROGRAM.FILE {./hardware/vivado/adpcm_mcu/adpcm.runs/impl_1/patmos_top.bit} [lindex [get_hw_devices xc7a100t_0] 0]
