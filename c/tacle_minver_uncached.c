...
int minver_minver(volatile _UNCACHED mat_type (*minver_a)[DIM][DIM], 
...
int _Pragma ("entrypoint")  minver_minver(volatile _UNCACHED mat_type (*minver_a)[DIM][DIM], 
...
int main( void ){
  ...
  minver_minver(&test_matrix->mat_a, DIM, eps );  
