...
int minver_minver(volatile _SPM mat_type (*minver_a)[DIM][DIM], 
...
int _Pragma ("entrypoint")  minver_minver(volatile _SPM mat_type (*minver_a)[DIM][DIM], 
...
int main( void ){
  ...
  minver_minver(&spm_matrix->mat_a, DIM, eps );  
