...
int _Pragma("entrypoint") adpcm_main_wcet()
{
	...
	write_vector_spm(&adpcm_data->compressed, TEST_SIZE, 1, 1, bank_ptr_array, 0);	
	...
	*hls_ptr;
	...
	read_vector_spm(&adpcm_data->dec_result, TEST_SIZE, 1, 2, bank_ptr_array, 0);
...
int adpcm_main_encode()
{
	...
	write_vector_spm(&adpcm_data->test_data, TEST_SIZE, 1, 0, bank_ptr_array, 0);
	...
	*hls_ptr = 1;	
	...
	read_vector_spm(&adpcm_data->compressed, TEST_SIZE, 1, 1, bank_ptr_array, 0);
