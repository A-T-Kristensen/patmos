...
int adpcm_dec_filtez(volatile _SPM int (*bpl)[6], volatile _SPM int (*dlt)[6]);
void adpcm_dec_upzero(int dlt, volatile _SPM int (*dlti)[6], volatile _SPM int (*bli)[6]);
...
volatile _SPM int (*adpcm_dec_h_p)[24];
...
volatile _SPM int (*adpcm_dec_accumc_p)[11];
volatile _SPM int (*adpcm_dec_accumd_p)[11];
...
volatile _SPM int (*adpcm_dec_delay_dhx_p)[6];
volatile _SPM int (*adpcm_dec_delay_bph_p)[6];
...
volatile _SPM int (*adpcm_dec_dec_del_bpl_p)[6];
volatile _SPM int (*adpcm_dec_dec_del_dltx_p)[6];
...
volatile _SPM int (*adpcm_dec_dec_del_bph_p)[6];
volatile _SPM int (*adpcm_dec_dec_del_dhx_p)[6];
...
void adpcm_dec_decode(volatile _SPM int* input)
{
	...
	h_ptr = &(*adpcm_dec_h_p)[0];
	ac_ptr = &(*adpcm_dec_accumc_p)[0];
	ad_ptr = &(*adpcm_dec_accumd_p)[0];
